...
window.SITE_CONFIG = {
  ...
  footer: {
    description: "Your trusted source for bath towel reviews, comparisons, and buying guides. Find the perfect towels for softness, absorbency, and durability.",
    quickLinks: [
  ...
  networkBanners: [
    ...
    },
    {
      ...
      description: "Expert reviews of the best shower heads — from rainfall to high-pressure to filtered designs. Upgrade your daily shower.",
